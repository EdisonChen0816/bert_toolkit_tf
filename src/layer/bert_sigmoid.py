...
class BertSigmoid:
    ...
    def __init__(self, bert_path, train_path, eval_path, max_length, batch_size, save_path, learning_rate, epoch, save_checkpoints_steps, tf_config, do_lower_case=True, warmup_ratio=.1):
