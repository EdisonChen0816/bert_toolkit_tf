...
def get_custom_getter(compute_type):
    def float32_variable_storage_getter(getter, name, shape=None, dtype=None, initializer=None,
...
class BertModel(object):
    ...
    def __init__(self, config, is_training, input_ids, input_mask=None, token_type_ids=None,
                 use_one_hot_embeddings=False, scope=None, compute_type=tf.float32):
        ...
        with tf.variable_scope(scope, default_name='bert_tf', custom_getter=get_custom_getter(compute_type)):
...
def attention_layer(from_tensor, to_tensor, attention_mask=None, num_attention_heads=1,
                    ...
                    attention_probs_dropout_prob=0.0, initializer_range=0.02, do_return_2d_tensor=False,
    ...
    if len(from_shape) == 3:
        batch_size, from_seq_length, to_seq_length = from_shape[0], from_shape[1], to_shape[1]
